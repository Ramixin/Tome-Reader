...
public class TomeReader implements ModInitializer {
    ...
    public void onInitialize() {
        ...
        Registry.register(Registries.SCREEN_HANDLER, new Identifier(MOD_ID, "lectern_enchanted_book"), LecternEnchantedBookScreenHandler.LECTERN_ENCHANTED_BOOK_SCREEN_HANDLER);
    }
